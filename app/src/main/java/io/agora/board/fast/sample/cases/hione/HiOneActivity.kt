...
open class HiOneActivity : BaseActivity() {
    ...
    private fun initView() {
        ...
        findViewById<View>(R.id.insert_pptx).setOnClickListener {
            ...
            val prefix = "https://conversion-demo-cn.oss-cn-hangzhou.aliyuncs.com/demo/dynamicConvert"
            val title = "开始使用 Flat"
        ...
        findViewById<View>(R.id.insert_image).setOnClickListener {
            val imageUrl = "https://flat-storage.oss-accelerate.aliyuncs.com/cloud-storage/2022-02/15/ebe8320a-a90e-4e03-ad3a-a5dc06ae6eda/ebe8320a-a90e-4e03-ad3a-a5dc06ae6eda.png"
            val width = 512.0
            val height = 512.0
